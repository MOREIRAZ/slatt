...
const InteractiveDemo = () => {
  ...
  const demoFeatures = {
    design: {
      title: "Personalização do LinkHub",
      description:
        "Cria os teus LinkHubs fantásticos com ferramentas poderosas: temas personalizados, imagens de fundo, cores e muito mais.",
      preview: (
    ...
    mobile: {
      title: "Criar vários LinkHubs",
      description:
        "Cria e gerência vários LinkHubs para servir diferentes propósitos ou públicos.",
      preview: (
    ...
    analytics: {
      ...
      description: "Acompanha quantas vezes cada um dos seus links é clicado.",
      preview: (
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-sm">Total de cliques</span>
            <span className="font-bold text-primary">2,888</span>
          </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid bg-primary/10 rounded-full w-full grid-cols-3 mb-8">
          ...
          >
            ...
            <span className="hidden sm:inline">Vários LinkHubs</span>
          </TabsTrigger>
          <TabsTrigger
            value="analytics"
  ...
  links: [
    {
      id: "",
      linkHubId: "",
      title: "ULTIMO LANÇAMENTO",
      url: "#",
      description: "Willow - VVS [Official Music Video]",
      icon: "/new.png",   
      type: "link",
      order: 0,
      isActive: true,
    ...
    },
    {
      ...
      title: "WEBSITE",
      url: "#",
      description: "Portfólio, Contactos...",
      icon: "/website.png",
      type: "link",
      order: 1,
      isActive: true,
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="text-center max-w-5xl mx-auto">
              ...
              >
                Cria um linkhub e personalizável para o teu publico alvo. 
                Partilha as tuas redes sociais, site, loja, vídeos, 
                música e muito mais com apenas um link.
              </motion.p>
            ...
            <div className="text-center mb-16">
              <div>
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                  Vê como o teu LinkHub vai aparecer para o teu público.
                </p>
              </div>
            </div>
