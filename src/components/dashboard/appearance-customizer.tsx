...
const buttonStyles = [
  { id: "10px", name: "Arredondado", preview: "rounded-lg" },
  { id: "0px", name: "Quadrado", preview: "rounded-none" },
  { id: "999px", name: "Pílula", preview: "rounded-full" },
];
    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Fale de ti para as pessoas..."
              rows={3}
              maxLength={160}
            />
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <Input
                ...
                placeholder="https://exemplo.pt/avatar.jpg"
                className="flex-1"
              />
            </div>
          </div>
      ...
      <div className="glass rounded-2xl p-6">
        <div className="flex items-center space-x-2 mb-6">
          ...
          <h2 className="text-xl font-semibold ">Design & Cores</h2>
        </div>
        ...
        <Tabs defaultValue="background" className="w-full">
          ...
          <TabsContent value="background" className="space-y-6 mt-6">
            ...
            {formData.backgroundType === "solid" && (
              <div>
                <Label htmlFor="backgroundColor">Cor do Background</Label>
                <div className="flex space-x-2">
                  <Input
                    id="backgroundColor"
                    type="color"
            ...
            {formData.backgroundType === "gradient" && (
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="customGradient">Gradiente CSS Personalizado</Label>
                  <Input
                    id="customGradient"
            ...
            {formData.backgroundType === "image" && (
              <div>
                ...
                <Input
                  ...
                  placeholder="https://exemplo.pt/background.jpg"
                />
              </div>
            )}

            <div>
              <Label htmlFor="textColor">Cor Texto</Label>
              <div className="flex space-x-2">
                <Input
                  id="textColor"
                  type="color"
      ...
      <Button onClick={handleSubmit} disabled={isLoading}>
        {isLoading ? "A Guardar..." : "Guardar Design"}
      </Button>
    </div>
  );
}
