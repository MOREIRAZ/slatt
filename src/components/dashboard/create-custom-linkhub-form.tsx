    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center space-x-2">
          <span className="text-sm text-gray-500">slattmusic.pt/</span>
          <Input
            id="slug"
            value={formData.slug}
            onChange={(e) =>
        ...
        <p className="text-xs text-gray-500">
          Apenas letras minúsculas, números e hífenes são permitidos.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder="Uma breve descrição deste LinkHub"
          rows={3}
        />
      </div>
